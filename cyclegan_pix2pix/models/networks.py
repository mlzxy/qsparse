...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect', sparse_kwargs=None):
        ...
        use_sparse = sparse_kwargs is not None
        print("Sparse In ResNet", use_sparse, sparse_kwargs)
...
class ResnetBlock(nn.Module):
    ...
    def __init__(self, dim, padding_type, norm_layer, use_dropout, use_bias, sparse_kwargs, name):
        ...
        self.use_sparse = sparse_kwargs is not None
        self.name = name
        print("Sparse In Resblock", name, self.use_sparse, sparse_kwargs)
    ...
    def build_conv_block(self, dim, padding_type, norm_layer, use_dropout, use_bias):
        ...
        if padding_type == 'reflect':
            ...
            raise NotImplementedError('padding [%s] is not implemented' % padding_type)
        conv_block += [nn.Conv2d(dim, dim, kernel_size=3, padding=p, bias=use_bias), norm_layer(dim),
                       SparseLayer(**self.sparse_kwargs, name=self.name + '_conv2') if self.use_sparse else nn.Identity()]
